...
public class SmartPasswordLoginActivity extends BaseActivity implements
        GoogleApiClient.OnConnectionFailedListener,
        View.OnClickListener, GoogleApiClient.ConnectionCallbacks {

    private static final String TAG = "SmartPasswordLoginActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Sign in button
        // mSingInButton=(Button)findViewById(R.id.button_google_sign_in);
    ...
    private void resolveResult(Status status, int requestCode) {
        if (!mIsResolving) {
            try {
                status.startResolutionForResult(SmartPasswordLoginActivity.this, requestCode);
                mIsResolving = true;
